...
2. Install, then ensure the resource is registered as JavaScript module with URL `/hacsfiles/pool_controller_dashboard/main.js` (HACS usually adds it automatically).
3. If you install manually, copy `www/pool_controller_dashboard/main.js` to your HA `config/www/pool_controller_dashboard/` and add resource `/local/pool_controller_dashboard/main.js`.
